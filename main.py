    """
    Token Refresher 8uesk2ts
    ========================
    Lightweight Flask/FastAPI microservice to validate HTTP traffic reliably.
    ...
    APP_NAME    = "Token Refresher 8uesk2ts"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight Flask/FastAPI microservice to validate HTTP traffic reliably.")
